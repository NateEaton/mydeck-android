...
For bookmarks with text content, MyDeck shows the extracted text in a clean, distraction-free reading layout. The bookmark title appears at the top — tap directly on the title text to edit it inline, then confirm with the **✓** checkmark or cancel with the **✗** icon. The text edit field will save the change when confirmed.

Tap any image in content to open it in the **Image Lightbox** (see below). Long-press links or images to access **Long-press Context Menus** (see below).
...
As you scroll down to read, the top bar hides to give you more screen space. It reappears when you scroll back toward the top or when you reach the end of the content.
...
At the end of the content (not anchored to the screen), you'll find two styled action buttons:

- **❤️ Add to favorite / Remove favorite** — toggle the favorite status
- **📦 Archive / Unarchive** — move the bookmark to the archive (or back to My List)

These buttons appear as pills that match the app's design theme and provide quick access to the most common organizing actions without needing to open the overflow menu.
...
- **From reading view:** tap **⋮** → **View Original**
- **From Original View:** tap **⋮** → **View Article** to return to the reading view

> **No article content:** If Readeck was unable to extract article content when the bookmark was saved, MyDeck automatically opens the bookmark in Original View instead of showing an empty reading view. In that case, the overflow menu will show **View Article** (to attempt the reading view) rather than **View Original**.
...
### Articles
Articles display extracted text content in a clean, distraction-free reading layout. They support full typography controls, text search, and may include images that can be opened in the **Image Lightbox**.
