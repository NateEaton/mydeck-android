...
Archiving moves a bookmark out of **My List** into the **Archive**. Archived bookmarks are not deleted — they remain available to read and can be moved back to My List at any time.
...
To delete several bookmarks at once, tap **⋮ → Select bookmarks**, choose the cards you want, then open the **⋮ overflow** and tap **Delete**. Selection mode exits and a **"N bookmarks deleted"** snackbar appears with an **Undo** action. The staged bookmarks stay greyed out until you tap **Undo** to restore them all, or let the snackbar go (or interact elsewhere) to confirm the deletion.
